...
import { Instagram, Ghost } from 'lucide-react'; // Using Ghost as a placeholder for a floral icon, wait, let's use something elegant. Flower is not in lucide by default? Let's use Sparkles or just text.
import { Sparkles } from 'lucide-react';

export default function Navbar() {
    return (
        <header className="sticky top-0 z-50 w-full bg-[#F6F4F1]/90 backdrop-blur-md border-b border-gray-200/50">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <a href="#" className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center text-[#1A1A1A] hover:bg-[#D4AF37] hover:text-white hover:border-[#D4AF37] transition-all">
